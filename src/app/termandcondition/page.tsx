      ...
      <div className="space-y-8 text-gray-700">
        ...
        <section id="introduction">
          ...
          <p className="text-white">
            <span className="font-semibold text-white">Purpose:</span> As part of accessing
          ...
          <p className="mt-4 text-white">
            <span className="font-semibold text-white">Scope of Agreement:</span> This
          ...
          <div className="bg-yellow-50 p-4 rounded-lg mt-4">
            <span className="font-semibold text-white">Modification of Terms:</span>{" "}
        ...
        <section id="eligibility">
          ...
          <div className="bg-black p-4 rounded-lg text-white">
            <span className="font-semibold text-white">Age Requirement:</span> Only users
          ...
          <div className="bg-black p-4 rounded-lg mt-4 text-white">
            <span className="font-semibold text-white">Jurisdictional Restrictions:</span>{" "}
        ...
        <section id="token-purchase">
          ...
          <div className="bg-black p-4 rounded-lg text-white">
            <span className="font-semibold text-white">Token Utility:</span> DCRX tokens
          ...
          <div className="bg-black p-4 rounded-lg mt-4 text-white">
            <span className="font-semibold text-white">Token Sale Structure:</span> The ICO
          ...
          <div className="bg-red-50 p-4 rounded-lg mt-4">
            <span className="font-semibold text-white">Non-Investment Disclaimer:</span>{" "}
