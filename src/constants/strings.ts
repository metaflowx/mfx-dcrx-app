class Strings {
  ...
  static email = "Email";
  static primaryEmailLink = "mailto:cpnsingh8181@gmail.com";
  static primaryEmail = "cpnsingh8181@gmail.com";
  ...
  static koFiUsername = "cp";

  static fullName = "Chandra Pratap Narayan SIngh";
  static shortName = "C.P.N Singh";
}
